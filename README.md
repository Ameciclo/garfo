...
- `/samu-calls/summary` - [Documentação](./docs/routes.md#samu-calls-summary)
- `/samu-calls/streets/top` - [Documentação](./docs/routes.md#samu-calls-streets-top)
- `/samu-calls/streets/search` - [Documentação](./docs/routes.md#samu-calls-streets-search)
- `/samu-calls/evolution` - [Documentação](./docs/routes.md#samu-calls-evolution)
