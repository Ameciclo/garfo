...
const {
  ...
  acessibility_evaluation: access_evaluation,
  ...
  all_obstacles_count,
  levels_obstacles_count,
  vertical_signs_count,
  start_vertical_sign_existence,
  end_vertical_sign_existence,
  crosses_with_vertical_sign_count,
  crosses_without_vertical_sign_count,
  cycle_stoplight_count,
  total_stoplight_count,
  additional_signs_count,
  horiontal_pattern_description: horiontal_pattern_evaluation,
...
const rates_tree = [
    ...
    calculate_average, ["project", "safety", "maintenance_and_urbanity"]],
        ...
        calculate_average, ["protection", "vertical_signs", "horizontal_signs", "comfort"]],
            ...
            calculate_average, ["project_conception", "project_risks", "segregation"]],
                ...
                calculate_evaluation_pattern, [project_conception_rates_pattern, `${cycle_flow} > ${traffic_flow} > ${localization}`]],
                ...
                calculate_binnary_rate, [all_risks_situations_count]],
                ...
                calculate_average, [segregator_type, buffer_width]],
                    ...
                    calculate_buffer_size, [buffer_width, typology, [0.3, 1]]],
            ...
            calculate_average, ["on_way_vertical_signs", "start_vertical_signs", "end_vertical_signs", "cross_vertical_signs", "stoplight", "additional_signs"], ],
                ...
                calculate_interpolated_values, [1000 * length, 50 * vertical_signs_count, [150, 50]]],
            ...
            calculate_average, ["horizontal_pattern", "picto_signs", "arrow_signs", "cross_horizontal_signs"]],
                ...
                calculate_evaluation_pattern, [horiontal_pattern_rates_pattern, horiontal_pattern_evaluation]],
            ...
            calculate_average, ["access", "pavement", "sinuosity", "width_evaluation", "levels", "two_way"]],
                ...
                calculate_access, [way_with_access, ways_without_access, all_access_count, access_evaluation], ],
                ...
                calculate_width_evaluation, [flow_direction, width, typology]],
                ["1.1.4.5",  "levels", "Desníveis", "Existência de desníveis na estrutura", 
                calculate_interpolated_values, [length, levels_obstacles_count], [1, 0.1]],
                ["1.1.4.6",  "two_way", "Bidirecionalidade", "Fluxo da estrutura.", 
                calculate_binnary_rate, [flow_direction]], // !!
        ...
        calculate_average, ["speed_control", "on_way_conflicts", "cross_conflicts"]],
            ...
            calculate_average, ["electronic_control", "level_control", "unlevel_control"]],
                ...
                calculate_interpolated_values, [1000 * length, 500 * electronic_control_points, [1000, 500], speed_limit > 30]],            
                ...
                calculate_average, ["square_size", "lane_width", "other_controls", "vertical_speed_sign", horizontal_speed_sign], ],
                    ...
                    calculate_interpolated_values, [length, other_controls_count, [1, 0.1], speed_limit <= 30]],
            ...
            calculate_average, ["on_way_risks",  "cyclists_conflicts", "on_way_main_vertical_signs", "horizontal_sign_conditions", "segregation"], ],
                ...
                calculate_binnary_rate, [on_way_risks_situations_count]],
        ...
        calculate_average, ["cross_risks", "project_conception", "horizontal_cross_conditions", "cross_vertical_signs"], ],
            ...
            calculate_binnary_rate, [crossing_risks_situations_count]],
    ...
    calculate_average, ["maintenance", "urbanity"]],
        ...
        calculate_average, [ "obstacles", "shading", "lighting", "access"]],
            ...
            calculate_obstacles, [length, all_obstacles_count]],
            ...
            calculate_lighting, [length, road_width, dedicated_ligthing, same_side_ligthing, other_side_ligthing]],
            // ["1.3.2.4",  "access", 
    ];
}
