const salvador2023 = {
    ...
    seg_length: { type: "float", salvador2023: "length_google_maps" },
    geo_id: { type: "int", salvador2023: "geo_id" },
    form_id: { type: "int", salvador2023: "form_id" },
  };

const forms_conversion = {
  salvador2023: salvador2023
}

function get_forms_conversion(city, year) {
  return forms_conversion[city+year]
} 

module.exports = get_forms_conversion;
